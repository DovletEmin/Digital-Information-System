...
from content.views import (
    ...
    RegisterView, ToggleBookmarkView, UserBookmarksView
)
...
schema_view = get_schema_view(
    openapi.Info(title="SMU API", default_version='v1', description="API для Sanly Maglumat Ulgamy"),
    public=True,
)
...
urlpatterns = [
    ...
    # Закладки
    path('bookmarks/toggle/<int:pk>/', ToggleBookmarkView.as_view(), name='toggle-bookmark'),
    path('bookmarks/', 
